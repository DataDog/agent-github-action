...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, start_1.startAgent)(imageName, containerName, apiKey, site);
...
function pullImage(imageName) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise(resolve => {
            const child = (0, child_process_1.spawn)('docker', ['pull', imageName], { stdio: 'pipe' });
            child.on('close', code => {
                if (code !== 0) {
