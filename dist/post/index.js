...
function stopAgent(containerName) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise(resolve => {
            const child = (0, child_process_1.spawn)('docker', ['exec', '-t', containerName, 'agent', 'stop'], { stdio: 'pipe' });
            child.on('close', code => {
                if (code !== 0) {
